        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="card-base card-hover p-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="tag-base">宏观经济</span>
              <span className="tag-base">货币政策</span>
              <span className="tag-base">金融监管</span>
            </div>
            ...
            <button className="btn-primary w-full">关注账号</button>
          </div>
          ...
          <div className="card-base card-hover p-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="tag-base">电动汽车</span>
              <span className="tag-base">太空探索</span>
              <span className="tag-base">人工智能</span>
            </div>
            <div className="grid grid-cols-3 gap-4 mb-4 text-center">
              <div>
          ...
          <div className="card-base card-hover p-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="tag-base">人工智能</span>
              <span className="tag-base">机器学习</span>
              <span className="tag-base">创业投资</span>
            </div>
            <div className="grid grid-cols-3 gap-4 mb-4 text-center">
              <div>
